        ...
        <div className='ddf ms-16 mt-16'>
            <div className="container">
                ...
                <div className="stripe"></div>
                    ...
                    <h1 className="product-title">GAMING.</h1>
                </div>

            </div>
            <div className="slider mx-auto ms-0 " style={{ hieght: '400px', width: '1000px', marginTop: '500px',marginLeft:'200px' }}>
